...
COMMANDS: list[PeerCommand] = [
    ...
    # OVERSEER_ERROR_ADAPT_PEER_WRAP_2026_09_08 — log/playbook language is error-adapt
    PeerCommand(
        "error-adapt",
        "agent",
        "Error adapt from plan-gate (never idle; --from-gate)",
        _py("peer_error_adapt.py", "--from-gate"),
        pivotal=True,
        tags=("dispatch", "heal", "error-adapt"),
    ),
    PeerCommand(
        "peer-glink-paste",
        "agent",
