...
def enqueue_comms_work(
    ...
    *,
    ...
    for opp in signals.opportunities:
        ...
        if _normalize_key(marker) in known or already_shipped(
            {"title": marker, "detail": opp.detail}, known
        ):
