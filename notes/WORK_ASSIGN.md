...
_Updated 2026-09-08 00:03:42_ · assign across niches · respect cursor-agent timeout
...
- **asn-1788736855-factory_** parallel_dispatch_coach→factory_engineer when=now eta=25m · [parallel-dispatch] Lane H — post-agent verify type=tests: first FAIL;
- **asn-1788736857-factory_** parallel_dispatch_coach→factory_engineer when=now eta=27m · [factory:parallel_orch] Phase 3 — worktrees + parallel Task peers; pat
- **asn-1788736935-tech_wri** parallel_dispatch_coach→tech_writer when=now eta=21m · [comms] GGWave/GibberLink docs only: when to use GLink vs MCP vs GGWav
- **asn-1788801268-factory_** queue_steward→factory_engineer when=now eta=27m · [parallel-dispatch] Lane H — dirty-tree isolate / KD fanout: worktree 
