...
class ImproveRankTests(unittest.TestCase):
    ...
    def test_queue_known_keys_content_fp_hit_skips_parse(self) -> None:
        ...
        improve.clear_queue_known_keys_cache()
        parses = {"n": 0}
        real_parse = improve._parse_done_item

        def counting_parse(stripped: str):
            parses["n"] += 1
            return real_parse(stripped)
        ...
        with mock.patch.object(improve, "_parse_done_item", side_effect=counting_parse), mock.patch.object(
