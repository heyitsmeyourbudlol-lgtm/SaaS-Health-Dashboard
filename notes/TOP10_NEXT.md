...
- **Measured (scoreboard 03:59Z):** peer+improve **active**; Active nonempty; **4 today · proj 24.0/day · week_avg 4.0 [GAP]** — `meets_bar=false` (need today≥8 observed). Do **not** false-close. Scoreboard meters CLEAN only (Mac sidecar no longer inflates).
